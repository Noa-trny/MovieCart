<?php
$pageTitle = 'Films de science-fiction';
$category = 'Sci-Fi';
...
<div class="category-header">
    <h1 class="category-title">Films de science-fiction</h1>
    <p class="category-description">Explorez des mondes futuristes, des univers parallèles et des technologies révolutionnaires.</p>
</div>
...
<div class="movies-grid">
    <?php if (empty($movies)): ?>
        <div class="empty-state">
            ...
            <p>Nous travaillons à étoffer notre catalogue de films de science-fiction.</p>
        </div>
    <?php else: ?>
