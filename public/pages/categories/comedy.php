...
<div class="category-header">
    <h1 class="category-title">Films de comédie</h1>
    <p class="category-description">Découvrez notre sélection de films hilarants pour des moments de rire et de détente.</p>
</div>
...
<div class="movies-grid">
    <?php if (empty($movies)): ?>
        <div class="empty-state">
            ...
            <p>Nous travaillons à étoffer notre catalogue de films de comédie.</p>
        </div>
    <?php else: ?>
